...
public class GoogleApiHelper {
    ...
    public static HttpRequestFactory createRequestFactory(String accessToken)
    ...
    public static String createRawEmailWithAttachments(String to, String subject, String body, List<File> attachments,
            List<Attachment> initAttachment) throws MessagingException, IOException {
        ...
        if (initAttachment != null) {
            for (Attachment attachment : initAttachment) {
                ...
                // Create a ByteArrayDataSource with the data, and the MIME type from the
                // attachment
    ...
    public static String getEmailBody(GmailApiMessage message, String accessToken, String emailId) {
        ...
        if (mimeType != null && (mimeType.startsWith("multipart/mixed") || mimeType.startsWith("multipart/related")
                || mimeType.startsWith("multipart/alternative"))) {
    ...
    private static Map<String, String> processParts(List<Part> parts, Base64.Decoder decoder, String accessToken,
            String emailId) {
        ...
        if (parts != null) {
            for (Part part : parts) {
                ...
                } else if (partMimeType.startsWith("multipart/related")
                        || partMimeType.startsWith("multipart/alternative")) {
            ...
            // Replace the "cid:" references with the corresponding Base64 encoded image
            // data
    ...
    public static String getAttachmentData(String attachmentId, String emailId, String accessToken)
            throws GeneralSecurityException, IOException {
        HttpRequestFactory httpRequestFactory = createRequestFactory(accessToken);
        GenericUrl attachmentUrl = new GenericUrl(
                GMAIL_API_BASE_URL + "/messages/" + emailId + "/attachments/" + attachmentId);
