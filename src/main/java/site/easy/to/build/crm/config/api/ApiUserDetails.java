...
public class ApiUserDetails implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        User user = userRepository.findByUsername(username).size() == 1 ? userRepository.findByUsername(username).get(0)
                : null;
        ...
        if (user == null) {
            ...
            if (user.getStatus().equals("suspended")) {
                HttpServletResponse httpServletResponse = ((ServletRequestAttributes) Objects
